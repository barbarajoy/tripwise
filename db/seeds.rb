...
while cpt_trip < 15
  ...
  if cpt_trip == 0
    comment = "Rome, la Ville Éternelle, est un trésor de l'histoire et de la culture qui vous transporte à travers les siècles. Explorez ses ruelles pittoresques, admirez les majestueux vestiges de l'Empire romain comme le Colisée et le Forum romain, et émerveillez-vous devant l'architecture grandiose de la Basilique Saint-Pierre. Dégustez une délicieuse cuisine italienne dans les trattorias locales et terminez la journée en jetant une pièce dans la Fontaine de Trevi pour un retour assuré à Rome. Une expérience inoubliable vous attend dans cette ville envoûtante."
  elsif cpt_trip == 1
    comment = "Venise, surnommée la \"Cité des Canaux\", est une ville unique au monde située en Italie, bâtie sur un archipel de 118 petites îles interconnectées par un réseau de canaux et de ponts. Explorez ses ruelles étroites, admirez son architecture médiévale, et découvrez des trésors artistiques inestimables dans ses églises et musées. Ne manquez pas une balade en gondole sur les canaux pittoresques et dégustez une cuisine italienne délicieuse dans ses charmants restaurants. Venez vivre une expérience hors du commun dans cette ville magique où l'eau est la route principale et l'histoire coule à chaque coin de rue."
  elsif cpt_trip == 2
    comment = "Florence, surnommée la \"Perle de la Renaissance\", est une ville italienne magnifique et chargée d'histoire située en Toscane. Elle est célèbre pour son architecture époustouflante, ses musées renommés abritant des trésors artistiques tels que \"David\" de Michel-Ange, ses rues pavées pittoresques, et son ambiance romantique le long de la rivière Arno. Vous pourrez vous imprégner de la culture italienne, déguster une cuisine délicieuse et découvrir l'héritage artistique exceptionnel de la ville en visitant des monuments tels que la cathédrale de Florence et le Ponte Vecchio. Florence est un véritable trésor de l'art, de l'histoire et de la beauté, à ne pas manquer lors de votre voyage en Italie."
  elsif cpt_trip == 3
    comment = "Milan, la capitale de la mode et du design en Italie, est une métropole cosmopolite située en Lombardie. Elle est réputée pour son style avant-gardiste, sa scène artistique dynamique et son patrimoine historique fascinant. Vous serez ébloui par son architecture contemporaine, ses musées de renommée mondiale, tels que la Pinacothèque de Brera, ainsi que par son atmosphère vibrante le long du canal Naviglio Grande. Explorez la richesse de la cuisine italienne dans les trattorias locales, découvrez des trésors artistiques comme la fresque de La Cène de Léonard de Vinci et le majestueux Duomo de Milan. Milan incarne la fusion parfaite entre la modernité et l'histoire, en faisant une destination incontournable lors de votre voyage en Italie."
  else
